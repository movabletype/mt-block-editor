...
export declare const BoldButton: {
    new (): {
        ...
        readonly tiptap: TiptapEditor | undefined;
        onEditorInit(editor: Editor, options: Record<string, unknown>): void;
        accessKey: string;
        ...
        pmViewDesc?: {
            ...
            destroy(): void;
            posBeforeChild(child: /*elided*/ any): number;
            ...
            nearestDesc(dom: Node): /*elided*/ any | undefined;
            nearestDesc(dom: Node, onlyNodes: true): {
                ...
                localPosFromDOM(dom: Node, offset: number, bias: number): number;
                nearestDesc(dom: Node): /*elided*/ any | undefined;
                nearestDesc(dom: Node, onlyNodes: true): /*elided*/ any | undefined;
                getDesc(dom: Node): /*elided*/ any | undefined;
                posFromDOM(dom: Node, offset: number, bias: number): number;
                descAt(pos: number): /*elided*/ any | undefined;
                ...
                setSelection(anchor: number, head: number, view: import('prosemirror-view').EditorView, force?: boolean): void;
...
export declare class HorizontalRuleButton extends ToolbarItemElement {
    constructor();
    connectedCallback(): void;
}
export declare class InsertHtmlButton extends ToolbarItemElement {
    constructor();
    connectedCallback(): void;
}
export declare class SourceButton extends ToolbarItemElement {
    constructor();
    connectedCallback(): void;
}
export declare class FullScreenButton extends ToolbarItemElement {
    #private;
    constructor();
    connectedCallback(): void;
}
