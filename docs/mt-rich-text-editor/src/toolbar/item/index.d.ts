import { HorizontalRuleButton, InsertHtmlButton, SourceButton, FullScreenButton } from './simple-buttons';
declare const _default: {
    bold: {
        new (): {
            ...
            editor: import('../..').Editor | undefined;
            options: Record<string, unknown>;
            readonly tiptap: import('@tiptap/core').Editor | undefined;
            onEditorInit(editor: import('../..').Editor, options: Record<string, unknown>): void;
            accessKey: string;
    ...
    insertHtml: typeof InsertHtmlButton;
