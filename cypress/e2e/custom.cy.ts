...
context("CustomBlock", () => {
  ...
  const expectedOembedMetadata = {
    url: "https://www.youtube.com/watch?v=NsXejoHIjOU",
    title: "mt-custom-block-builder",
    authorName: "Taku Amano",
    authorUrl: "https://www.youtube.com/@takuamano540",
    type: "video",
    height: 150,
    width: 200,
    version: "1.0",
    ...
    thumbnailHeight: 360,
    thumbnailWidth: 480,
    thumbnailUrl: "https://i.ytimg.com/vi/NsXejoHIjOU/hqdefault.jpg",
  };
  ...
  context("custom-wrap_remove_intermediate", () => {
    if (!Cypress.env("ci")) {
      ...
      it("oembed", () => {
        ...
        const expectedResult = `<!-- mt-beb t="core-context" m='${JSON.stringify(
          { 1: expectedOembedMetadata, 2: { removeIntermediateProduct: true } }
        )}' --><!-- /mt-beb --><!-- mt-beb t="custom-wrap_remove_intermediate" m='2' h='&lt;!-- mt-beb t="sixapart-oembed" m=&#x27;1&#x27; --&gt;&lt;!-- /mt-beb --&gt;' --><div class="custom-wrap-remove-intermediate"><iframe width="200" height="150" src="https://www.youtube.com/embed/NsXejoHIjOU?feature=oembed" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen="" title="mt-custom-block-builder"></iframe></div><!-- /mt-beb -->`;
        ...
        cy.window().then((w) => {
          expectedResolvedCount = w.MTBlockEditorOembedResolved.length;
        });
        ...
        const expectedResult2 = `<!-- mt-beb t="core-context" m='${JSON.stringify(
          { 1: { removeIntermediateProduct: true }, 2: expectedOembedMetadata }
        )}' --><!-- /mt-beb --><!-- mt-beb t="custom-wrap_remove_intermediate" m='1' h='&lt;!-- mt-beb t="sixapart-oembed" m=&#x27;2&#x27; --&gt;&lt;!-- /mt-beb --&gt;' --><div class="custom-wrap-remove-intermediate"><iframe width="200" height="150" src="https://www.youtube.com/embed/NsXejoHIjOU?feature=oembed" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen="" title="mt-custom-block-builder"></iframe></div><!-- /mt-beb --><!-- mt-beb --><p>extra content</p><!-- /mt-beb -->`;

        serializedTextarea(textareaId).should(($input) => {
          const value = $input.val();
          expect(value).to.equal(`${expectedResult2}`);
        });

        unload({ id: textareaId });

        cy.window().then((w) => {
          expect(w.MTBlockEditorOembedResolved.length).to.equal(
